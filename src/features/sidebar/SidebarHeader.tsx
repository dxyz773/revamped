function SidebarHeader() {
  return (
    <header className="mt-32">
      <h1 className="text-[45px] sm:text-[58px] lg:text-[50px] font-extrabold text-shadow max-w-[436px] dark:text-stone-200 leading-16 text-shadow-stone-50 flush-text tracking-wide">
