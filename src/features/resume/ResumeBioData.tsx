...
const resumeBioData: ResumeBio = [
  ...
  },
  {
    title: "Versatile",
    description:
      "Adept at independent problem-solving and team collaboration. Seamlessly navigates artistic and technical spaces.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    title: "User-Focused",
    description:
      "Powered by insights in psychology, storytelling, and customer service. Constructs interfaces with users in mind that feel natural and meaningful.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
